			...
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-8 col-lg-push-2">
						<form role="form" action="<?php echo base_url('martrick/editProfile'); ?>" method="post">
							<div class="form-group col-lg-12">
								<div class="col-lg-6"><label>User Name:</label></div>
								 <div class="col-lg-6">

								 <input class="form-control" placeholder="" name="username" value="<?php echo $profile->username;?>" > 
