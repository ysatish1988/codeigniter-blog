...
<div class="row">
	...
	<form name="candidate_personal_info_form" id="candidate_personal_info_form" action="" enctype="multipart/form-data">
		<div class="col-lg-3 col-lg-push-1">
			<div class="row">
				<div class="col-lg-8" id="image" style="background-color:#EEE; height:221px; width:210px; border:2px solid #58ADCC; color:#D9534F;" >
					...
					<div style="margin-top:-25px; margin-left:28px;">Upload Image <i class="fa fa-camera" style="color:#D9534F;"></i><input type="file" name="candidate_file" id="candidate_file" class="imageicon">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row" style="margin-top:50px;">
			<div class="col-lg-12 col-lg-push-1" style="margin-top:50px; margin-left: -5px;">
									...
									<div class="col-lg-12" style="   margin-top: 10px;">
										...
										<div class="col-lg-10">
											 <div class="form-group">
												  <select class="form-control"  name="country" width="50%" id="sel1">
										   ...
										   <div class="col-lg-12" style="    margin-top: 10px;">
											...
											<div class="col-lg-12" style="margin-top: 10px;">
												...
												<div class="col-lg-5" >
													<div class="col-lg-7" style="padding-left:0px;">
														<div class="col-lg-12">
														 <input id="date_of_birth" name ="date_of_birth" class="form-control date_of_birth datepicker" placeholder="Birth Date" value="<?php echo set_value('date_of_birth');?>"/>
														</div>
													</div>
													<div class="col-lg-5 col-lg-pull-1">
																		...
																		<div id="collapseOne" class="panel-collapse collapse in">
																			<div class="panel-body">
																				<div class="col-lg-12" style="margin-top: 10px;">
																					...
																					<div class="col-lg-5" >
																						<div class="col-lg-6" style="padding-left:0px;">
																							<div class="col-lg-10">
																								<input  type="text" class="form-control datepicker" name="from_date[]" placeholder="From" >
																							</div>
																						</div>
																						<div class="col-lg-6">
																							<div class="col-lg-10 col-lg-pull-2" style="margin-left:5px;">
																								<input  type="text" class="form-control datepicker"  name="to_date[]" placeholder="To" >
																							</div>
																						</div>
																					</div>
																				</div>
																				<div class="col-lg-12" style="margin-top: 10px;" >
																					...
																					<div class="col-lg-5" >
																						<div class="col-lg-10">
																							<select class="form-control"  name="worked_country[]" width="50%" id="sel1">
																							<option>Select Country</option>
																							<?php foreach ($countries as $key => $country) { ?>
																							<option value="<?php echo $country->id; ?>"><?php echo $country->country_name ; ?></option>
																							<?php } ?>
																				...
																				<div class="col-lg-12" style="    margin-top: 10px;">
																					...
																					<div class="col-lg-5" >
																						<div class="col-lg-10">
																							<input  type="text" class="form-control" name="worked_city[]" placeholder="City" >
																						</div>
																					</div>
																					<div class="col-lg-5" >
																						<div class="col-lg-10">
																							<input type="text" class="form-control" name="worked_street[]" placeholder="Street" >
																						</div>
																					</div>
																				</div>
																				<div class="col-lg-12" style="   margin-top: 10px;">
															...
															<div id="collapseOne" class="panel-collapse collapse in">
																<div class="panel-body">
																	<div class="col-lg-12" style="   margin-top: 10px;">
																		...
																		<div class="col-lg-5 col-lg-pull-1" >
																			<div class="col-lg-10">
																				<select class="form-control"  name="passing_year[]" width="50%" id="sel1">	
																			<?php $start_year = 1950; $end_year = date('Y'); for($i=$start_year; $i<=$end_year; $i++  ) { ?>
																				<option value="<?echo $i; ?>"><?echo $i; ?></option>
																				<? } ?>
																				</select>
																			</div>
																		</div>
																		<div class="col-lg-5 col-lg-pull-2" style="margin-left:18px;">
																			<div class="col-lg-10">
																				<input class="form-control" name=" institute[]" placeholder="Institute" >
																			</div>
																		</div>
																	</div>
																	<div class="col-lg-12" style="   margin-top: 10px;">
																		...
																		<div class="col-lg-5" >
																			<div class="col-lg-10 col-lg-pull-2">
																				<input class="form-control" name="achievments[]" placeholder="Achievements" >
																			</div>
																		</div>
																		<div class="col-lg-2 col-lg-pull-2" >
																		<input type="file" name="education_doc_file[]" accept="pdf"/>
																		</div>
																	</div>
																	<div class="col-lg-12" style="margin-top: 10px;">
																		<div class="col-lg-1" >
																...
																<div class="panel-body">
																	<div class="col-lg-12" style="margin-top: 10px;">
																		...
																		<div class="col-lg-10" >
																			...
																			<div class="col-lg-7 col-lg-pull-2">
																				Yes <input type="radio" name="current_availability" class="current_availability" value="1" checked>
																				No  <input type="radio" name="current_availability" class="current_availability" value="0">
																			</div>
																		</div>
																	</div>
																	<div id="availiablity_div" class="col-lg-12 col-lg-pull-1" style="margin-top: 10px;">
																		<div class="col-lg-3 col-lg-push-2" style="margin-left:-2px; padding-left:39px;" >
																			Available Until:
																		</div>
																		<div class="col-lg-9" >
																			<div class="col-lg-6">
																				...
																				<div class="col-lg-7 col-lg-pull-1">
																					<input type="text" class="form-control datepicker" name="available_from" placeholder="Available From" >
																				</div>
																			</div>
																			<div class="col-lg-6">
																				<div class="col-lg-5">
																				</div>
																				<div class="col-lg-7 col-lg-pull-8">
																					<input type="text" class="form-control datepicker" name="available_to" placeholder="Available To" >
																				</div>
																			</div>
																		</div>
																	</div>
																							...
																							<div class="col-lg-12">
																								<div class="col-lg-12 ">
																									<h4 class="panel-title">
																										...
																										<a id="" class="glyphicons col-md-2 add_personal_doc_button" style=" width:30px; cursor: pointer; cursor: hand;float:right;"><i class="fa fa-plus"></i></a>
																									</h4>
																								</div>
																							</div>
																						</div>
																					</div>
																					<div id="collapseNineteen" class="panel-collapse">
																						<div id="collapseOne" class="panel-collapse collapse in">
																							<div class="panel-body">
																								<div class="col-lg-12" style="   margin-top: 10px;">
																									<div class="col-lg-1" >
																							...
																							<?php } ?>
																								...
																								<div class="col-lg-12" style="   margin-top: 10px;">
																									...
																									<div class="col-lg-5" >
																										<div class="col-lg-10">
																											<input class="form-control datepicker" placeholder="Valid Through" >
																										</div>
																									</div>
																								</div>
				...
				<div class="btn-group col-lg-2 col-lg-push-3" style="margin-bottom:20px;">
...
//});
   var allowd_max = 100; //maximum input boxes allowed
        ...
        $(add_button_med).click(function () {
            if (x < allowd_max) { 
                x++; 
$('#add_div').prepend('<div id="remove_'+x+'" class="col-lg-12"><div class="panel-group ADD_COMPANY" id="accordion8"><div class="panel panel-default"><div class="panel-heading"><div class="row"><div class="col-lg-12"><div class="col-lg-12"><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion8" href="#collapse_'+x+'" style="text-decoration:none;"><div class="col-lg-2"><i class="fa fa-sort-down"></i></div><div class="col-lg-8 col-lg-pull-2" style="margin-left:20px; font-size:18px; font-weight:bold;">Company</div></a><a id="'+x+'" class="glyphicons col-md-2 " style=" width:30px; cursor: pointer; cursor: hand;float:right;" onclick="removeeDiv('+x+');">X</a></h4></div></div></div></div><div id="collapse_'+x+'" class="panel-collapse"><div id="collapseOne" class="panel-collapse collapse in"><div class="panel-body">   <div class="col-lg-12" style="margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-5" ><div class="col-lg-10"><input type="text" class="form-control" name="company_name[]" placeholder="Company Name" ></div></div><div class="col-lg-5" ><div class="col-lg-6" style="padding-left:0px;"><div class="col-lg-10"><input  type="text" class="form-control datepicker" name="from_date[]" placeholder="From" ></div></div><div class="col-lg-6"><div class="col-lg-10 col-lg-pull-2" style="margin-left:5px;"><input type="text" class="form-control datepicker" name="to_date[]" placeholder="To" ></div></div></div></div> <div class="col-lg-12" style="margin-top: 10px;" ><div class="col-lg-1" ></div><div class="col-lg-5" ><div class="col-lg-10"><input type="text" class="form-control" name="position[]" placeholder="Position" ></div></div><div class="col-lg-5" ><div class="col-lg-10 country_list"></div></div></div>  <div class="col-lg-12" style="margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-5" ><div class="col-lg-10"><input type="text" class="form-control" name="worked_city[]" placeholder="City" ></div></div><div class="col-lg-5" ><div class="col-lg-10"><input type="text" class="form-control" name="worked_street[]" placeholder="Street" ></div></div></div><div class="col-lg-12" style="   margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-10" ><div class="col-lg-2"></div></div></div></div></div></div></div></div></div>');
    
    $(".country_list").html("<select class='form-control'  name='worked_country[]' width='50%' id='sel1'><option>Select Country</option><?php foreach ($countries as $key => $country): ?><option value='<?php echo $country->id; ?>'><?php echo $country->country_name; ?></option><?php endforeach; ?></select>");
    $( ".datepicker" ).datepicker({ dateFormat: 'dd-mm-yy' ,yearRange: '1900:' + new Date().getFullYear(),changeMonth: true, changeYear: true});        
            }
        });
        ...
        $(add_button_rec).click(function () {
            ...
            if (x < allowd_max) { 
                x++; 
$('#add_education_div').prepend(' <div id="remove_'+x+'" class="col-lg-12"><div class="panel-group ADD_COMPANY" id="accordion8"><div class="panel panel-default"><div class="panel-heading"><div class="row"><div class="col-lg-12"><div class="col-lg-12 "><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion11" href="#collapse_'+x+'" " style="text-decoration:none;"><div class="col-lg-2"><i class="fa fa-sort-down"></i></div><div class="col-lg-8 col-lg-pull-2" style="margin-left:20px;font-size:18px; font-weight:bold;">Education</div></a><a id='+x+' class="glyphicons col-md-2" style=" width:30px; cursor: pointer; cursor: hand;float:right; margin-left:-50px;" onclick="removeDiv('+x+');">X</a></h4></div></div></div></div><div id="collapse_'+x+'" class="panel-collapse"><div id="collapseOne" class="panel-collapse collapse in"><div class="panel-body"><div class="col-lg-12" style="   margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-5 col-lg-pull-1" ><div class="col-lg-10"><select class="form-control"  name="passing_year[]" width="50%" id="sel1"><?php $start_year = 1950; $end_year = date('Y'); for($i=$start_year; $i<=$end_year; $i++  ) { ?><option value="<?echo $i; ?>"><?echo $i; ?></option><? } ?></select></div></div><div class="col-lg-5 col-lg-pull-2" style="margin-left:18px;"><div class="col-lg-10"><input class="form-control" name=" institute[]" placeholder="Institute" ></div></div></div><div class="col-lg-12" style="   margin-top: 10px;"><div class="col-lg-5" ><div class="col-lg-10"><input class="form-control" name="qualification[]" placeholder="Qualification" ></div></div><div class="col-lg-5" ><div class="col-lg-10 col-lg-pull-2"><input class="form-control" name="achievments[]" placeholder="Achievements" ></div></div><div class="col-lg-2 col-lg-pull-2" ><input type="file" name="education_doc_file[]" accept="pdf"/></div></div><div class="col-lg-12" style="margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-10" ><div class="col-lg-2"></div></div></div></div></div></div></div></div></div>													');
               
            }
        });
 var allowd_max = 100;
 var x=1;
 $('.add_personal_doc_button').click(function(){
 	
 	if (x < allowd_max) { 
	                x++; 
	$('#personal_doc').prepend('<div id="remove_peronal_doc'+x+'"class="col-lg-12"><div class="panel-group" id="accordion8"><div class="panel panel-default"><div class="panel-heading"><div class="row"><div class="col-lg-12"><div class="col-lg-12 "><h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion18" href="#collapseNineteen" style="text-decoration:none;"><div class="col-lg-2"><i class="fa fa-sort-down"></i></div><div class="col-lg-8 col-lg-pull-2" style="margin-left:20px; font-size:18px; font-weight:bold;">Passport/ Id Cards/ Licences</div></a><a id='+x+' class="glyphicons col-md-2" style=" width:30px; cursor: pointer; cursor: hand;float:right; margin-left:-50px;" onclick="removePersonalDocDiv('+x+');">X</a></h4></div></div></div></div><div id="collapseNineteen" class="panel-collapse"><div id="collapseOne" class="panel-collapse collapse in"><div class="panel-body"><div class="col-lg-12" style=" margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-5" ><div class="col-lg-10"><input class="form-control" placeholder="Type Of Document" ></div></div><div class="col-lg-5" ><div class="col-lg-10 country_list"></div></div></div><div class="col-lg-12" style=" margin-top: 10px;"><div class="col-lg-1" ></div><div class="col-lg-5" ><div class="col-lg-10"><input class="form-control" placeholder="Document No" ></div></div><div class="col-lg-5" ><div class="col-lg-10"><input class="form-control datepicker" placeholder="Valid Through" ></div></div></div><div class="col-lg-12" style="border-right:1px solid #ccc; margin-top: 10px;"><div class="col-lg-1" ></div></div></div></div></div></div>'
		);
	$(".country_list").html("<select class='form-control'  name='worked_country[]' width='50%' id='sel1'><option>Select Country</option><?php foreach ($countries as $key => $country): ?><option value='<?php echo $country->id; ?>'><?php echo $country->country_name; ?></option><?php endforeach; ?></select>");
    $( ".datepicker" ).datepicker({ dateFormat: 'dd-mm-yy' ,yearRange: '1900:' + new Date().getFullYear(),changeMonth: true, changeYear: true}); 
...
function removePersonalDocDiv(divId)
{
	$("#remove_peronal_doc"+divId).remove();
}
</script>
<!-- 
 <script>
...
$(document).ready(function(){
    $("#personalinformation").click(function() {	
		...
		// postData.append("video", $("#candidate_file")[0].files[0]);
		$.ajax({
				type: "POST",
...
$(document).ready(function(){
		...
		$('.current_availability').click(function(){
			$('#availiablity_div').toggle();
		});
});
</script>		