                              ...
                              <form class="form" method="post" action="">
                                <fieldset>
									  ...
									  <div class="form-group" style=" color:#000;border-color: #DDD;">
										...
										<div class="form-group" style=" color:#000;border-color: #DDD;">
											<a href="<?php echo base_url('martrick/forgotPassword');?>" class="btn btn-lg btn-primary btn-block" style="background-color:#fff; border-color: #fff; color:#000;">Forgot Password</a>
										</div>
                                </fieldset>
                              </form>
                            </div>
