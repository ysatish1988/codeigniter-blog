							...
							<form role="form" method="post" action="" enctype="multipart/form-data">
								<div class="form-group col-lg-12">
									<div class="col-lg-3"><label > User Name:</label></div>
									 <div class="col-lg-9">
											<input text="text" name="username" class="form-control" placeholder="" value="<?php if(isset($recruiter) && !empty($recruiter)) { echo $recruiter->username;}else{ echo set_value('username');}?>" >
