							...
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="col-lg-12" >
										...
										<div class="col-lg-5" >
											<div class="col-lg-10"><input class="form-control" placeholder="Title" ></div>
										</div>
										<div class="col-lg-5" >
											<div class="col-lg-10"><input class="form-control" placeholder="Street" ></div>
										</div>
									</div>
									<div class="col-lg-12" style="    margin-top: 10px;">
										<div class="col-lg-1" ></div>
										<div class="col-lg-5" >
											<div class="col-lg-10"><input class="form-control" placeholder="First Name" ></div>
										</div>
										<div class="col-lg-5" >
											<div class="col-lg-7" style="padding-left:0px;">
												<div class="col-lg-12"><input class="form-control" placeholder="City" ></div>
											</div>
											<div class="col-lg-5 col-lg-pull-1">
												<div class="col-lg-10"><input class="form-control" placeholder="Zip" ></div>
											</div>
										</div>
									</div>
									<div class="col-lg-12" style="   margin-top: 10px;">
										<div class="col-lg-1" ></div>
										<div class="col-lg-5" >
											<div class="col-lg-10"><input class="form-control" placeholder="Middle Name" ></div>
										</div>
										<div class="col-lg-5" >
											<div class="col-lg-10"><input class="form-control" placeholder="Country" ></div>
										</div>
									</div>
										   <div class="col-lg-12" style="    margin-top: 10px;">
										      <div class="col-lg-1" >
											...
											<div class="col-lg-10">
											<input class="form-control" placeholder="Additional Address Information" >
											</div>
											 </div>
										  </div>
											<div class="col-lg-12" style="    margin-top: 10px;">
												...
												<div class="col-lg-5" >
													<div class="col-lg-7" style="padding-left:0px;">
														<div class="col-lg-12"><input id='datepicker'  class="form-control" placeholder="Birth Date"></div>
													</div>
													<div class="col-lg-5 col-lg-pull-1">
														<div class="col-lg-10"><input class="form-control" placeholder="Age" ></div>
													</div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Phone Number Home" ></div>
												</div>
											</div>
										   <div class="col-lg-12" style="   margin-top: 10px;">
												 <div class="col-lg-1" ></div>
												 <div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Nationality" ></div>
												 </div>
												 <div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Mobile Number" ></div>
												 </div>
										  </div>
										   <div class="col-lg-12" style="    margin-top: 10px;">
												 <div class="col-lg-1" ></div>
												 <div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Born in" ></div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Fax Number" ></div>
												 </div>
										  </div>
										   <div class="col-lg-12" style="    margin-top: 10px;">
												<div class="col-lg-1" ></div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Mother Tongue" ></div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Email" ></div>
												</div>
										  </div>
										   <div class="col-lg-12" style="    margin-top: 10px;">
												<div class="col-lg-1" ></div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Language1" ></div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Wedding Status" ></div>
												</div>
										  </div>
										   <div class="col-lg-12" style="   margin-top: 10px;">
												<div class="col-lg-1" ></div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Language2" ></div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Children" ></div>
												</div>
										  </div>
										   <div class="col-lg-12" style="    margin-top: 10px;">
												<div class="col-lg-1" ></div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Actual Position" ></div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Hobbies" ></div>
												</div>
										  </div>
										   <div class="col-lg-12" style="    margin-top: 10px;">
												<div class="col-lg-1" ></div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Company" ></div>
												</div>
												<div class="col-lg-5" >
													<div class="col-lg-10"><input class="form-control" placeholder="Driving Licences" ></div>
												</div>
												<div class="btn-group col-lg-2 col-lg-push-3" style="margin-top:30px;">
													<button type="button" class="btn btn-primary btn-sm dropdown-toggle col-lg-12 col-lg-push-12" data-toggle="dropdown" style="background-color:#000;">Submit</button>
												</div>
										  </div>
                                        </div>
                                    </div>
